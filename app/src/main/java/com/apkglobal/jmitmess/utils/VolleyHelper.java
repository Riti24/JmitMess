package com.apkglobal.jmitmess.utils;
...
import com.apkglobal.jmitmess.Amaze;
...
public class VolleyHelper {
    ...
    public static void postRequestVolley(final Context ctx,final VolleyInterface vi, String url, final HashMap<String, String> hm, final int request_code) throws NullPointerException {
